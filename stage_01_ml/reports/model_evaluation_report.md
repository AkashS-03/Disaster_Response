...
- **river_level**: 0.2179
- **river_level_rolling_72h_avg**: 0.1601
- **rainfall_rolling_72h_sum**: 0.1027
- **river_level_trend**: 0.0913
- **emergency_call_volume**: 0.0881

## Classification Report
```text
              precision    recall  f1-score   support

    MODERATE       0.30      0.01      0.01       924
      SEVERE       0.84      1.00      0.91      4932

    accuracy                           0.84      5856
   macro avg       0.57      0.50      0.46      5856
weighted avg       0.76      0.84      0.77      5856
